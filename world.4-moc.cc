/****************************************************************************
** Meta object code from reading C++ file 'world.4.hh'
**
...
#error "The header file 'world.4.hh' doesn't include <QObject>."
...
static const char qt_meta_stringdata_World[] = {
    "World\0modechange(Action)\0\0select(int)\0"
    "hide(int)\0"
};
...
void World::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->modechange((*reinterpret_cast< Action(*)>(_a[1]))); break;
        case 1: _t->select((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->hide((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject World::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_World,
...
// SIGNAL 0
void World::modechange(Action _t1)
{
